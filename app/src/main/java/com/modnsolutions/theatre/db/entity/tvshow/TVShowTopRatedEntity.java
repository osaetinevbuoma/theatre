...
@Entity(tableName = "tv_show_top_rated")
public class TVShowTopRatedEntity {
    @PrimaryKey
    private int id;
    ...
    public TVShowTopRatedEntity(int id, String backdropPath, String firstAirDate, String name,
    ...
    @Ignore
    public TVShowTopRatedEntity(int id, String backdropPath, int episodeRuntime,
    ...
    public boolean equals(Object o) {
        ...
        TVShowTopRatedEntity that = (TVShowTopRatedEntity) o;
        return id == that.id &&
