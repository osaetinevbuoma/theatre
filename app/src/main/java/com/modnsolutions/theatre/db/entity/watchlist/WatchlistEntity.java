...
public class WatchlistEntity {
    ...
    @Ignore
    public WatchlistEntity(int id, int typeId, int remoteId, String backdropPath, long budget,
    ...
    @Ignore
    public WatchlistEntity(int id, int typeId, int remoteId, String backdropPath, String genre,
