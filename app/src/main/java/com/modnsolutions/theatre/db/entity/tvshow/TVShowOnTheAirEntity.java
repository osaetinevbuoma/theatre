...
@Entity(tableName = "tv_show_on_the_air")
public class TVShowOnTheAirEntity {
    @PrimaryKey
    private int id;
    ...
    public TVShowOnTheAirEntity(int id, String backdropPath, String firstAirDate, String name,
    ...
    @Ignore
    public TVShowOnTheAirEntity(int id, String backdropPath, int episodeRuntime,
    ...
    public boolean equals(Object o) {
        ...
        TVShowOnTheAirEntity that = (TVShowOnTheAirEntity) o;
        return id == that.id &&
