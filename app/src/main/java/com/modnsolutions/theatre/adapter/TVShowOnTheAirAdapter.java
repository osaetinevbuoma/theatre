...
public class TVShowOnTheAirAdapter extends RecyclerView.Adapter<TVShowOnTheAirAdapter.ViewHolder> {
    private Context mContext;
    private LayoutInflater mLayoutInflater;
    private final AsyncPagedListDiffer<TVShowOnTheAirEntity> mDiffer = new AsyncPagedListDiffer(
            this, DIFF_CALLBACK);

    public TVShowOnTheAirAdapter(Context context) {
        mContext = context;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        TVShowOnTheAirEntity tvShow = mDiffer.getItem(position);
    ...
    public void submitList(PagedList<TVShowOnTheAirEntity> pagedList) {
        mDiffer.submitList(pagedList);
    }

    public static final DiffUtil.ItemCallback<TVShowOnTheAirEntity> DIFF_CALLBACK = new DiffUtil
            .ItemCallback<TVShowOnTheAirEntity>() {
        @Override
        public boolean areItemsTheSame(@NonNull TVShowOnTheAirEntity oldItem,
                                       @NonNull TVShowOnTheAirEntity newItem) {
            return oldItem.getId() == newItem.getId();
        }

        @Override
        public boolean areContentsTheSame(@NonNull TVShowOnTheAirEntity oldItem,
                                          @NonNull TVShowOnTheAirEntity newItem) {
        ...
        public ViewHolder(@NonNull final View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    TVShowOnTheAirEntity tvShow = mDiffer.getItem(getAdapterPosition());
