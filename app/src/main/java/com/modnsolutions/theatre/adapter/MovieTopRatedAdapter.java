...
public class MovieTopRatedAdapter extends RecyclerView.Adapter<MovieTopRatedAdapter.ViewHolder> {
    ...
    private final AsyncPagedListDiffer<MovieTopRatedEntity> mDiffer = new AsyncPagedListDiffer(
            this, DIFF_CALLBACK);

    public MovieTopRatedAdapter(Context context) {
        mContext = context;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        MovieTopRatedEntity movie = mDiffer.getItem(position);
    ...
    public void submitList(PagedList<MovieTopRatedEntity> pagedList) {
        mDiffer.submitList(pagedList);
    }

    public static final DiffUtil.ItemCallback<MovieTopRatedEntity> DIFF_CALLBACK = new DiffUtil
            .ItemCallback<MovieTopRatedEntity>() {
        @Override
        public boolean areItemsTheSame(@NonNull MovieTopRatedEntity oldItem,
                                       @NonNull MovieTopRatedEntity newItem) {
            return oldItem.getId() == newItem.getId();
        }

        @Override
        public boolean areContentsTheSame(@NonNull MovieTopRatedEntity oldItem,
                                          @NonNull MovieTopRatedEntity newItem) {
        ...
        public ViewHolder(@NonNull final View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    MovieTopRatedEntity movie = mDiffer.getItem(getAdapterPosition());
