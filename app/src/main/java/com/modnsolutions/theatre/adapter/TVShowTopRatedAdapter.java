...
public class TVShowTopRatedAdapter extends RecyclerView.Adapter<TVShowTopRatedAdapter.ViewHolder> {
    private Context mContext;
    private LayoutInflater mLayoutInflater;
    private final AsyncPagedListDiffer<TVShowTopRatedEntity> mDiffer = new AsyncPagedListDiffer(
            this, DIFF_CALLBACK);

    public TVShowTopRatedAdapter(Context context) {
        mContext = context;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        TVShowTopRatedEntity tvShow = mDiffer.getItem(position);
    ...
    public void submitList(PagedList<TVShowTopRatedEntity> pagedList) {
        mDiffer.submitList(pagedList);
    }

    public static final DiffUtil.ItemCallback<TVShowTopRatedEntity> DIFF_CALLBACK = new DiffUtil
            .ItemCallback<TVShowTopRatedEntity>() {
        @Override
        public boolean areItemsTheSame(@NonNull TVShowTopRatedEntity oldItem,
                                       @NonNull TVShowTopRatedEntity newItem) {
            return oldItem.getId() == newItem.getId();
        }

        @Override
        public boolean areContentsTheSame(@NonNull TVShowTopRatedEntity oldItem,
                                          @NonNull TVShowTopRatedEntity newItem) {
        ...
        public ViewHolder(@NonNull final View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    TVShowTopRatedEntity tvShow = mDiffer.getItem(getAdapterPosition());
