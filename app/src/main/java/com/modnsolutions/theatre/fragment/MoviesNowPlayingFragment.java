...
import com.modnsolutions.theatre.adapter.MovieNowPlayingAdapter;
import com.modnsolutions.theatre.db.entity.movie.MovieNowPlayingEntity;
import com.modnsolutions.theatre.db.viewmodel.movie.MovieNowPlayingViewModel;
...
public class MoviesNowPlayingFragment extends Fragment implements LoaderManager
    ...
    private MovieNowPlayingAdapter mAdapter;
    ...
    private static final String CURRENT_PAGE = "com.modnsolutions.MoviesNowPlayingFragment" +
            ".CURRENT_PAGE";
    private MovieNowPlayingViewModel mMovieViewModel;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new MovieNowPlayingAdapter(getContext());
        mRecyclerView.setAdapter(mAdapter);
        mRecyclerView.setLayoutManager(new GridLayoutManager(getContext(), 3));

        mMovieViewModel = ViewModelProviders.of(this).get(MovieNowPlayingViewModel.class);
        mMovieViewModel.fetchMovies().observe(this, new Observer<PagedList<MovieNowPlayingEntity>>() {
            @Override
            public void onChanged(PagedList<MovieNowPlayingEntity> pagedList) {
        ...
        try {
            ...
            for (int i = 0; i < data.size(); i++) {
                ...
                if (mMovieViewModel.findMovieById(movie.getInt("id")) == null) {
                    ...
                    MovieNowPlayingEntity entity = new MovieNowPlayingEntity(movie.getInt("id"),
