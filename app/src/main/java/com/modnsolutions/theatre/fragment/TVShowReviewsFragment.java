...
public class TVShowReviewsFragment extends Fragment implements LoaderManager
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (intent != null) {
            ...
            if (Utilities.checkInternetConnectivity(getContext())) {
                ...
                bundle.putInt(TV_SHOW_ID_BUNDLE, mID);
    ...
    public Loader<JSONObject> onCreateLoader(int id, @Nullable Bundle args) {
        ...
        int tvShowId = args.getInt(TV_SHOW_ID_BUNDLE, -1);

        return new ReviewsAsyncTaskLoader(getContext(), currentPage, tvShowId, false);
    }
