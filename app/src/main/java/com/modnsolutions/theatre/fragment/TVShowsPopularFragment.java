...
public class TVShowsPopularFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        new FetchTVShowsAsyncTask(mLoading, mAdapter, TVShowType.POPULAR).execute(page);
    ...
    private void loadMore(RecyclerView recyclerView) {
        ...
        if (lastPosition == mAdapter.getItemCount() - 1) {
            ...
            page += 1;
            new FetchTVShowsAsyncTask(mLoadingMore, mAdapter, TVShowType.POPULAR).execute(page);
